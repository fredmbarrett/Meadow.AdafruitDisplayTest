...
namespace Meadow.Foundation.Displays
{
    ...
    /// </summary>
    public class St7789Modified : TftSpiBase, IRotatableDisplay
    {
        /// <summary>
        ...
        public St7789Modified(ISpiBus spiBus, IPin chipSelectPin, IPin dcPin, IPin resetPin,
        ...
        /// <param name="height">Height of display in pixels</param>
        /// <param name="colorMode">The color mode to use for the display buffer</param>
        public St7789Modified(ISpiBus spiBus, IDigitalOutputPort chipSelectPort,
